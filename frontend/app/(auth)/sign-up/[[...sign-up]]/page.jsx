  ...
  return (
    <section className="bg-slate-50 dark:bg-slate-950 min-h-screen flex items-center justify-center">
      <div className="w-full grid lg:grid-cols-12 min-h-screen">
        ...
        <section className="relative hidden lg:flex lg:col-span-6 xl:col-span-7 flex-col justify-between p-12 bg-slate-950 text-white overflow-hidden">
          ...
          <div className="relative z-10 max-w-xl my-auto py-10">
            ...
            <h1 className="text-3xl xl:text-4xl font-extrabold tracking-tight text-white leading-tight">
              Start Practicing and Land Your Dream Job Faster
            </h1>

            <p className="mt-4 text-slate-300 text-base leading-relaxed">
              Join thousands of job seekers preparing for top tech interviews. Upload your resume or choose custom job roles to begin your mock interview sessions.
            </p>
            ...
            <div className="mt-8 space-y-3.5">
              <div className="flex items-center gap-3 text-sm text-slate-200">
                ...
                <span>Generate role-specific and resume-based mock interviews in seconds</span>
              </div>
              <div className="flex items-center gap-3 text-sm text-slate-200">
                <div className="p-1 rounded-full bg-indigo-500/20 text-indigo-400">
                  <Mic className="w-4 h-4" />
                </div>
                <span>Interactive speech recognition &amp; webcam simulation</span>
              </div>
              <div className="flex items-center gap-3 text-sm text-slate-200">
                <div className="p-1 rounded-full bg-amber-500/20 text-amber-400">
                  <Trophy className="w-4 h-4" />
                </div>
                <span>Detailed feedback, scoring, and personalized improvement metrics</span>
              </div>
            </div>
          </div>
        ...
        {/* Right Sign Up Form — Centered Middle */}
